...
ShipFast.dev comes packed with authentication and authorization functionality that is built-in, making it easy for
...
[User Module](../../../working/users) guides for detailed information.

:::

----

_ShipFast.dev provides a robust authentication and authorization system out of the box, allowing you to secure your
