...
in recent years due to its flexibility and efficiency. The ShipFast.dev includes GraphQL API in all modules, making
...
### GraphQL in the ShipFast.dev

The ShipFast.dev includes GraphQL API in all modules, making it easy to build scalable and efficient applications.
The ShipFast.dev provides automated scripts that take care of updating frontend code, ensuring that all types are
...
The ShipFast.dev also supports real-time data updates using subscriptions. With subscriptions, developers can create
a live connection between the client and server, allowing for real-time communication and updates.

:::info
If you would like to learn more about the technical aspects of the GraphQL API in ShipFast.dev, please refer to:
[Working with GraphQL](/working/graphql)
:::