...
ShipFast.dev offers a powerful CMS functionality out of the box that is integrated with Contentful.

Using the CMS functionality in ShipFast.dev allows developers and administrators to easily manage content in the
...
### CMS Functionality in ShipFast.dev

ShipFast.dev offers two parts of the application that use content from the CMS.
...
The two implementations of the CMS functionality in ShipFast.dev are just examples of how to use the integration
