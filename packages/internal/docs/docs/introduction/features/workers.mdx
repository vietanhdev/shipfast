...
### Async Workers in the ShipFast.dev

The ShipFast.dev includes “async workers” feature that uses AWS Lambda functions and the Serverless Framework to
...
:::info
If you would like to learn more about the technical aspects of the async workers in ShipFast.dev, please refer to:
[Async workers](/working/async-workers)
:::