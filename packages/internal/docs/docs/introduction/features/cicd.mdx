...
new features and bug fixes, while also improving the quality and reliability of the application. The ShipFast.dev
...
### Pre-configured CI/CD in the ShipFast.dev

The ShipFast.dev includes a pre-configured CI/CD pipeline that is included in the infrastructure as code out of the
...
The ShipFast.dev provides a consistent and repeatable way to deploy your application, which
...
:::info
If you would like to learn more about the technical aspects of the CI/CD in ShipFast.dev, please refer to following
resources:
