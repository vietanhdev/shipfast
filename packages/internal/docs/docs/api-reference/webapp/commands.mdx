...
Find more about plop generator in the [devtools section](../../working/dev-tools/plop).
...
You can find more about updating GraphQL schema [here](../../working/graphql/web-app/update-schema)
