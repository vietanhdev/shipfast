...
### `pnpm nx g @shipfast/tools:webapp-lib`
...
[How to create a new webapp library package?](../../working/project-structure/create-web-lib) guide.
...
S3 bucket that is accessed by the [`Version matrix`](../../working/dev-tools/version-matrix) tool.
...
by the [`Version matrix`](../../working/dev-tools/version-matrix) tool.
