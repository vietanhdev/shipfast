...
| `AWS_VAULT_PROFILE` | Name of your AWS vault profile. Learn more about AWS vault [here](../aws/deploy-to-aws/configure-aws-credentials#store-aws-credentials-in-secure-place) | `shipfast` |
| `NX_BRANCH`         |                                                                                                                                                         | `local`            |
