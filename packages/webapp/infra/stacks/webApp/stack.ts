...
import { EnvConstructProps, getCloudfrontCertificateArn, getHostedZone } from '@shipfast/infra-core';
import { UsEastResourcesStack, WebAppCloudFrontDistribution } from '@shipfast/infra-shared';
